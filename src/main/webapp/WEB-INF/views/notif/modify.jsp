                    ...
                    <div class="card-body">
                        <form>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="n_title" id="title" class="form-control" required
                                       value='<c:out value="${dto.n_title}"></c:out>'>
                                <div class="invalid-feedback">Title is required.</div>
                            </div>

                            <div class="mb-3">
                                <label for="content" class="form-label">Content</label>
                                <input type="text" name="n_content" id="content" class="form-control" required
                                       value='<c:out value="${dto.n_content}"></c:out>'>
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="checkbox" name="n_isImp" ${dto.n_isImp?"checked":""}>
                            </div>
