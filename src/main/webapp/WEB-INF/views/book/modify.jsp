                        ...
                        <form>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="b_title" class="form-control" required
                                       value='<c:out value="${dto.b_title}"></c:out>'>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="b_author" class="form-control" required
                                       value='<c:out value="${dto.b_author}"></c:out>'>
                                <div class="invalid-feedback">Author is required.</div>
                            </div>

                            <div class="input-group mb-3">
                                <span class="input-group-text">ISBN</span>
                                <input type="text" name="b_isbn" class="form-control" required
                                       value='<c:out value="${dto.b_isbn}"></c:out>'>
                                <div class="invalid-feedback">ISBN is required.</div>
                            </div>

                            <div class="input-group mb-3">
                                <span class="input-group-text">Released Year</span>
                                <input type="number" name="b_year" class="form-control" min="1000" max="9999" required
                                       value='<c:out value="${dto.b_year}"></c:out>'>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="b_publisher" class="form-control"
                                       value=<c:out value="${dto.b_publisher}"></c:out>>
                            </div>

                            <div class="input-group mb-3">
                                <span class="input-group-text">Category</span>
                                <input type="text" name="b_category" class="form-control" required
                                       value=<c:out value="${dto.b_category}"></c:out>>
