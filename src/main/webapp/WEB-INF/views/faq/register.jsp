                    ...
                    <div class="card-body">
                        <form>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="question" name="f_question" rows="6" required></textarea>
                                <div class="invalid-feedback">Please provide a question content.</div>
                            </div>

                            <div class="mb-3">
                                <label for="answer" class="form-label">Answer</label>
                                <textarea class="form-control" id="answer" name="f_answer" rows="6" required></textarea>
